package me.itz0cat.catclient.api.font;
...
public class JColor extends Color {
    ...
    public static JColor getGuiColor() {
        GeneralSettings settings = CatClient.modManager().getMod(GeneralSettings.class);
        return (settings != null) ? settings.mainColor.getColor() : new JColor(0.00f, 0.78f, 1.00f);
    }
