package me.itz0cat.catclient.api.discord;
...
import static me.itz0cat.catclient.CatClient.LOGGER;
...
public class DiscordClient {
    ...
    private static void updatePresence(){
        if(CatClient.modManager().getMod(GeneralSettings.class).enableDiscordRPC.isEnabled()){
            if(mc.world == null || mc.player == null){
                if(Game.getGameState() == 1) {
                    DiscordRichPresence presence = new DiscordRichPresence();
                    presence.details = "Playing Minecraft " + SharedConstants.getGameVersion().name();
                ...
                if(mc.isInSingleplayer()) {
                    ...
                    DiscordRichPresence presence = new DiscordRichPresence();
                    presence.details = "Playing Minecraft " + SharedConstants.getGameVersion().name();
                    if(CatClient.modManager().getMod(GeneralSettings.class).showAddress.isEnabled()) {
