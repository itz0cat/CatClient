...
public class CatMenu implements Renderable {
    private static CatMenu instance;

    public static CatMenu getInstance() {
        if (instance == null) {
            instance = new CatMenu();
        }
        return instance;
    }
    ...
    public Theme getTheme() {
        return new Theme() {
            ...
            public void preRender() {
                ...
                colors[ImGuiCol.SeparatorHovered]       = new float[]{0.00f, 0.78f, 1.00f, 0.78f};
                colors[ImGuiCol.SeparatorActive]        = new float[]{0.00f, 0.78f, 1.00f, 1.00f};
                ...
                colors[ImGuiCol.TabUnfocusedActive]     = new float[]{0.00f, 0.45f, 0.70f, 1.00f};
                ...
                colors[ImGuiCol.TextSelectedBg]         = new float[]{0.00f, 0.78f, 1.00f, 0.35f};
                colors[ImGuiCol.DragDropTarget]         = new float[]{1.00f, 1.00f, 0.00f, 0.90f};
                colors[ImGuiCol.NavHighlight]           = new float[]{0.00f, 0.78f, 1.00f, 1.00f};
