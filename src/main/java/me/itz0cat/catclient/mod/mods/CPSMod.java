...
public class CPSMod extends Mod implements HudElement {
    ...
    public final BooleanSetting rightClickEnabled = new BooleanSetting("Right Click", this, true);
    ...
    public void renderHud(DrawContext context, RenderTickCounter tickCounter) {
        ...
        String textStr = !rightClickEnabled.isEnabled() ?
                (backgroundEnabled.isEnabled() ? CPSHelper.getCPS(0) + " CPS" : "[" + CPSHelper.getCPS(0) + " CPS]") :
                (backgroundEnabled.isEnabled() ? CPSHelper.getCPS(0) + " | " + CPSHelper.getCPS(1) + " CPS" : "[" + CPSHelper.getCPS(0) + " | " + CPSHelper.getCPS(1) + " CPS]");
