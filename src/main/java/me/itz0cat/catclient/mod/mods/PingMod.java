...
public class PingMod extends Mod implements HudElement {
    ...
    private long getPing() {
        return mc.getCurrentServerEntry() == null ? 0 : mc.getCurrentServerEntry().ping;
    }
    ...
    public void renderHud(DrawContext context, RenderTickCounter tickCounter) {
        ...
        long ping = getPing();
        String textStr = (backgroundEnabled.isEnabled() ? "" : "[") + ping + " ms" + (backgroundEnabled.isEnabled() ? "" : "]");
