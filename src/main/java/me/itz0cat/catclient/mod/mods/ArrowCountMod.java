...
public class ArrowCountMod extends Mod implements Renderable {
    ...
    public void render() {
        ...
        if(!CatClient.modManager().getMod("Arrow Count").isEnabled()) {
            firstFrame = true;
            return;
        }
        ...
        String text;
        if(backgroundEnabled.isEnabled()) text = getArrows() + " arrows";
        else text = "[" + getArrows() + " arrows]";
