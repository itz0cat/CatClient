...
public class ServerIPMod extends Mod implements HudElement {
    ...
    public final NumberSetting width = new NumberSetting("Width", this, 100, 50, 250, 1);
    ...
    public void renderHud(DrawContext context, RenderTickCounter tickCounter) {
        ...
        String textStr = (backgroundEnabled.isEnabled() ? "" : "[") + address + (backgroundEnabled.isEnabled() ? "" : "]");
